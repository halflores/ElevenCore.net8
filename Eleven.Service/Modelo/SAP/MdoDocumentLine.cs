...
{
    public class MdoDocumentLine
    {
        public MdoDocumentLine()
        {
            DocumentLineAdditionalExpenses = new List<MdoDocumentLineAdditionalExpense>();
        ...
        public List<MdoDocumentLineAdditionalExpense> DocumentLineAdditionalExpenses { get; set; }
        //CENTRO DE COSTOS
